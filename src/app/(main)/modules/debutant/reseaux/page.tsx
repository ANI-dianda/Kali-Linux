...
export const metadata = { title: 'Module 1.2 : Bases des Réseaux — Académie Cybersécurité' };
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="flex items-center gap-2 font-exo-2 text-sm text-gray-500 mb-8">
        ...
        <span>/</span><span className="text-gray-400">Débutant</span>
        <span>/</span><span className="text-white">Module 1.2</span>
      </div>
      <div className="rounded-2xl border border-white/10 bg-white/5 p-12 text-center">
        ...
        <h1 className="font-orbitron text-3xl font-black text-white mb-4">Module 1.2 : Bases de l'Informatique et des Réseaux</h1>
        <p className="font-exo-2 text-gray-400 mb-4 max-w-lg mx-auto">TCP/IP, DNS, HTTP, modèle OSI, infrastructure réseau — ce module arrive bientôt.</p>
        <div className="flex items-center justify-center gap-2 text-sm text-gray-500 font-exo-2 mb-8">
          <Clock className="h-4 w-4" /> 6 à 8 heures · Prérequis : Module 1.1
        </div>
      ...
      <div className="flex items-center justify-between mt-8 pt-8 border-t border-white/10">
        <Link href="/modules/debutant/intro-cyber" className="inline-flex items-center gap-2 font-exo-2 text-sm text-gray-400 hover:text-white transition-colors">
          <ChevronLeft className="h-4 w-4" /> Module 1.1
        </Link>
        <Link href="/modules/debutant/linux-kali" className="inline-flex items-center gap-2 font-exo-2 text-sm text-gray-400 hover:text-white transition-colors">
          Module 1.3 <ChevronRight className="h-4 w-4" />
        </Link>
      </div>
    </div>
  );
